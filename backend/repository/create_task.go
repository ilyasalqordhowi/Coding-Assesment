...
sql := `INSERT INTO task ("title","descriptions","statusId") VALUES ($1,$2,$3) RETURNING *`
row,err := db.Query(context.Background(),sql,dataTask.Title,dataTask.Descriptions,dataTask.StatusId)
